...
public class SettingVoiceChannelCategory extends QueueSetting<Category>{
	...
	public SettingVoiceChannelCategory(long serverId, long queueId, Category value) {
	...
	public void set(String[] args) {
		...
		List<Category> categories = ServerManager.getGuild(getServerId()).getCategoriesByName(categoryName, true);
